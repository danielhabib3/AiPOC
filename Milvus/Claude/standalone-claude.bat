...
docker run -d ^
    ...
    -v "%cd%\volumes-claude:/var/lib/milvus" ^
    -v "%cd%\embedEtcd-claude.yaml:/milvus/configs/embedEtcd-claude.yaml" ^
    -v "%cd%\user-claude.yaml:/milvus/configs/user-claude.yaml" ^
    -p 19531:19530 ^
    -p 9092:9091 ^
    -p 2380:2379 ^
